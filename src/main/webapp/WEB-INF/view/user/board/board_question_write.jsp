				...
				<div id="customer_container">
					...
					<form id="WriteForm" class="form-horizontal">
						<fieldset>
							...
							<div class="well well-black write">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" id="input_subject" placeholder="제목를 입력하세요." required autofocus />
									</div>
									<div class="col-sm-3">
										<div class="checkbox-inline">
											<label for="notice_yn"><input type="checkbox" name="notice_yn" id="notice_yn" /> 공지사항</label>
										</div>
										<div class="checkbox-inline">
											<label for="secret_yn"><input type="checkbox" name="secret_yn" id="secret_yn" /> 비밀글</label>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" rows="10" id="input_memo" required></textarea>
									</div>
								</div>
