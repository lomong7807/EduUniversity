						...
						<table class="table text-center table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-left">
										<div class="text-overflow">
											<a href="?BoardMode=view">학교법인 정의학원 정관시행세칙 (시행일 2022-12-07) </a>
										</div>
									</td>
									<td class="hidden-xs"><a href="#" class="ico ico_file" target="_blank" title="1213 파일 다운로드">파일</a></td>
								...
								<tr>
									...
									<td class="text-left">
										<div class="text-overflow">
											<a href="?BoardMode=view">학교법인 정의학원 정관시행세칙 (시행일 2022-12-07) <span class="ico ico_secret">비밀글</span>
											</a>
										</div>
									</td>
									<td class="hidden-xs"><span class="ico ico_file_non">파일없음</span></td>
								...
								<tr>
									...
									<td class="text-left">
										<div class="text-overflow">
											<a href="?BoardMode=view">학교법인 정의학원 정관시행세칙 (시행일 2022-12-07) <span class="ico ico_img">이미지첨부</span>
											</a>
										</div>
									</td>
									<td class="hidden-xs"><span class="ico ico_file_non">파일없음</span></td>
