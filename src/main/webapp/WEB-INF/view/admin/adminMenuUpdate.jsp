			...
			<div class="main-content">
				...
				<div id="container">
					<div class="dashboard">
						...
						<!-- 내용 -->
						<div>
							<form name="form" method="post" action="menu_update_proc"
								class="form-horizontal">
								<input id="menu_seq" type="hidden" value="${menu.menu_seq }">
								<fieldset>
									<div class="well wh-bg mb10"
										...
										<div class="form-group" id="form-group-depth">
											...
											<div class="col-sm-4">
												<select id="p_menu" name="p_menu_seq"
													style="max-width: 500px" class="form-control pointer">
										...
										<div class="form-group" id="form-group-auth_level">
											...
											<div class="col-sm-4">
												<input type="number" name="order_num" class="form-control"
													value="${menu.order_num }" style="max-width: 500px">
											</div>
										</div>
										<div class="form-group" id="form-group-dir">
											...
											<div class="col-sm-4">
												<input type="text" name="dir" class="form-control"
													value="${menu.dir }" style="max-width: 500px">
											</div>

											<label class="col-sm-2 control-label xs-mt10"> <strong>파일명</strong></label>
											<div class="col-sm-4">
												<input type="text" name="dir" class="form-control"
													value="${menu.file_name }" style="max-width: 500px">
											</div>
										</div>
										<div class="form-group" id="form-group-icon_class">
											...
											<div class="col-sm-4">
												<input type="text" name="icon_class" class="form-control"
													value="${menu.icon_class }" style="max-width: 500px">
											</div>
						...
						<div class="row pull-right">
							...
							<a href="/admin/adminMenuMng" class="btn btn-mini btn-default"><i
...
function save() {
	  ...
	  let arr = ['menu_seq', 'title', 'url', 'depth', 'p_menu_seq','auth_level','order_num', 'dir', 'file_name', 'icon_class', 'visible', 'new_window'];
