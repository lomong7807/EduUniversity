								...
								<div class="well wh-bg">
									<div class="form-group">
										<label for="common_cd" class="col-sm-2 control-label"><i
											class="fa fa-star text-danger nano-small" aria-hidden="true"></i><strong>공통코드</strong></label>
										<div class="col-sm-4">
											<input type="text" class="form-control" id="common_cd"
												name="common_cd" />
										</div>
										<label for="cd_value" class="col-sm-2 control-label"><i
											class="fa fa-star text-danger nano-small" aria-hidden="true"></i><strong>코드값</strong></label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="upper_cd" class="col-sm-2 control-label"><strong>상위코드</strong></label>
										<div class="col-sm-4">
											<input type="text" class="form-control" id="upper_cd"
												name="upper_cd" />
										</div>
										<label for="sort_No" class="col-sm-2 control-label xs-mt10">
											<strong>정렬번호</strong>
										</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" id="sort_No"
												name="sort_No" placeholder="숫자" />
										</div>
									</div>
									<!-- //기본사항 -->
