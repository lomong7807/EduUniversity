					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-3">
							<a href="?BoardMode=view"><img src="/img/user/sample03.jpg"
								class="thumbnail thumbnail-non mb10 img-responsive" alt="" /></a>
							<div class="caption text-center pt0">
								<a href="?BoardMode=view"> <strong>스마트워크 제품을...</strong><span
									class="ico ico_new">새글</span>
								</a>
						...
						<div class="col-sm-4 col-md-3">
							<a href="?BoardMode=view"><img src="/img/user/sample03.jpg"
								class="thumbnail thumbnail-non mb10 img-responsive" alt="" /></a>
							<div class="caption text-center pt0">
								<a href="?BoardMode=view"> <strong>스마트워크 제품을...</strong>
								</a>
								<div class="small">관리자</div>
							</div>
						</div>
						...
						<!-- Loop -->
						<div class="col-sm-4 col-md-3">
							<a href="?BoardMode=view"><img src="/img/user/sample10.jpg"
								class="thumbnail thumbnail-non mb10 img-responsive" alt="" /></a>
							<div class="caption text-center pt0">
								<a href="?BoardMode=view"> <strong>스마트워크 제품을...</strong>
								</a>
						...
						<!-- Loop -->
						<div class="col-sm-4 col-md-3">
							<a href="?BoardMode=view"><img src="/img/user/sample11.jpg"
								class="thumbnail thumbnail-non mb10 img-responsive" alt="" /></a>
							<div class="caption text-center pt0">
								<a href="?BoardMode=view"> <strong>스마트워크 제품을...</strong>
								</a>
