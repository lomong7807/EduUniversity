			...
			<div id="container" class="col-md-9">
				...
				<div id="customer_container">
					...
					<div class="row portfolio">
						<!-- Loop -->
						<div class="col-sm-4">
							<a href="?BoardMode=view" class="thumbnail"> <img
								src="/img/user/sample11.jpg" class="img-responsive" alt="" />
								<div class="caption text-center mb0">
									<div>
										<strong>스마트워크 제품을 개발</strong> <span class="ico ico_new">새글</span>
									</div>
						...
						<div class="col-sm-4">
							<a href="?BoardMode=view" class="thumbnail"> <img
								src="/img/user/sample10.jpg" class="img-responsive" alt="" />
								<div class="caption text-center mb0">
									<div>
										<strong>스마트워크 제품을 개발</strong>
									</div>
									<div class="text-muted">관리자</div>
								</div>
							</a>
