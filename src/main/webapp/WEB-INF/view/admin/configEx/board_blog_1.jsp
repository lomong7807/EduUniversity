			...
			<div id="container" class="col-md-9">
				...
				<div id="customer_container">
					...
					<div class="row">
						<!-- Loop -->
						<div class="col-sm-4">
							<a href="?BoardMode=view&amp;BoardID=blog" class="blog-img">
								<img src="/img/user/sample03.jpg"
								class="img-responsive img-rounded" alt="우리의 자신의 사업" />
							</a>
							<div class="blog-desc">
								<a href="?BoardMode=view&amp;BoardID=blog"
									class="subject h4 mb10 "><strong>우리의 자신의 사업</strong></a> <span
									class="post-date num-webfont"><i class="fa fa-calendar"></i>
									2018.10.13</span>
								<p class="text-muted mb10">표준의 표준에서 자체적으로 개발한 서비스로 온라인과
									오프라인에서도 좋은 반응을 얻고 있습니다.</p>
								<a href="?BoardMode=view&amp;BoardID=blog"
									class="btn btn-xs btn-default">더보기</a>
							</div>
						</div>
						<!-- //Loop -->
