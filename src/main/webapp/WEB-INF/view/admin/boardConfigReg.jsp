							...
							<fieldset>
								<div class="well wh-bg">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="main_banner_text" value="1500" required />
										</div>
										<label for="t_UnitCost" class="col-sm-2 control-label"> <i class="text-danger nano-small" aria-hidden="true"></i> 업로드 제한(개수)
										</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" name="main_banner_text" value="15" required />
										</div>
									</div>
									<div class="form-group">
...
$('.form-horizontal').on('submit',(e)=>{
	...
	let arr = ['board_name','list_num','title_length','view_level','write_level','skin_dir','board_type','header_include','footer_include','is_file_use','max_file_size','max_file_num','is_editor_use','is_reply_use','is_comment_use'];
