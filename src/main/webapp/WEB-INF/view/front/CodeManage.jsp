								...
								<table class="table text-center table-hover">
									...
									<tbody>
										...
										<tr class="odd pointer">
											...
											<td class="hidden-xs"><strong>172</strong></td>
											<td class="hidden-xs"><strong>ACADEMY_LEVEL</strong></td>
											<td class="hidden-xs"><strong>>non</strong></td>
											<td class="hidden-xs"><strong>>비회원</strong></td>
											<!-- 작은화면 목록 -->
											<td class="text-left hidden-sm hidden-md hidden-lg">
												<div class="hidden-sm hidden-md hidden-lg">
													<ul class="list-icon mb5">
														<li><span class="text-info">코드종류 </span> : ACADEMY_LEVEL</li>
														<li><span class="text-info">코드값 </span> :non</li>
														<li><span class="text-info">제목 </span> : 비회원</li>
...
<script>
<link ="//cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js">
function searchKey(){
	console.log('aa');
