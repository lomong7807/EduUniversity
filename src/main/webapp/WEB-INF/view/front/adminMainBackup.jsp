                        ...
                        <div class="tab-content pb0">
                            <div role="tabpanel" class="" id="">
                                <div class="row">
                                    ...
                                    <!-- 회원 비회원 방문자 비율 -->
                                    <%@ include file="dashboard/userVisitRate.jsp"%>
                        ...
                        <div class="tab-content pb0">
                            <div role="tabpanel" class="
                                ...
                                <div class="row">
                                    ...
                                    <%@ include file="dashboard/visitorsByToday.jsp"%>
        ...
        c3.generate({
            ...
            data: {
                ...
                columns: [
                    ...
                    ["2015", 1000, 1650, 1400, 2700, 2000, 1400, 2200, 2100, 190, 1000, 1700, 2500],
                    ["2016", 1010, 800, 1000, 850, 1250, 900]
                ],
                type: "spline"
            },
            axis: {
